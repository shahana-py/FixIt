...
//       setState(() {
//         _favoriteProductIds = Set<String>.from(favoritesDoc['productIds'] ?? []);
//       });
//     }
//   }
//
...
//           _currentUserServices = List<String>.from(
...
//         List<String> categories = List<String>.from(product['serviceCategories']);
...
//       List<String> productCategories = List<String>.from(product['serviceCategories'] ?? []);
//       return productCategories.any((category) => _currentUserServices.contains(category));
//     }).toList();
//
//     setState(() {
...
//                         return DropdownMenuItem<String>(
//                           value: type,
//                           child: Text(type == 'All' ? 'All Prices' : '$type Price'),
//                         );
//                       }).toList(),
//                       onChanged: (String? newValue) {
//                         setDialogState(() {
...
//                     favoriteProducts: _allProducts.where((product) =>
...
//                       Row(
//                         children: [
//                           Icon(Icons.recommend, color: Colors.orange[600]),
...
//                       ),
//                     ),
//                     if (_selectedCategory != 'All' || _searchController.text.isNotEmpty || _priceFilterType != 'All')
//                       TextButton.icon(
//                         onPressed: () {
//                           setState(() {
...
//     right: 8,
//     child: GestureDetector(
//     onTap: () => _toggleFavorite(_currentFavorites[index]['id']),
//     child: Container(
//     padding: const EdgeInsets.all(4),
//     decoration: BoxDecoration(
//     color: Colors.white.withOpacity(0.8),
...
//
//       if (favoritesDoc.exists) {
//         List<String> favoriteIds = List<String>.from(favoritesDoc['productIds'] ?? []);
//         setState(() {
...
//                       (widget.product['serviceCategories'] as List).isNotEmpty) ...[
//                     const Text(
...
//                       spacing: 8,
//                       runSpacing: 8,
//                       children: (widget.product['serviceCategories'] as List<dynamic>)
...
//                 onPressed: () {
//                   // Add to cart or rent functionality
//                   _showRentDialog();
//                 },
...
//                 Navigator.of(context).pop();
//                 ScaffoldMessenger.of(context).showSnackBar(
//                   const SnackBar(content: Text('Rental booking feature not implemented yet')),
//                 );
//               },
...
//                           value: type,
//                           child: Text(
//                               type == 'All' ? 'All Prices' : '$type Price'),
//                         );
//                       }).toList(),
//                       onChanged: (String? newValue) {
//                         setDialogState(() {
