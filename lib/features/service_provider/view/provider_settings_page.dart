...
class ServiceProviderSettingsPage extends StatefulWidget {
  ...
  @override
  _ServiceProviderSettingsPageState createState() => _ServiceProviderSettingsPageState();
}

class _ServiceProviderSettingsPageState extends State<ServiceProviderSettingsPage> {
  // Settings variables
  ...
  Future<void> _loadSettings() async {
    ...
    setState(() {
      ...
      _availabilityStatus = prefs.getBool('availability_status') ?? true;
  ...
  Future<void> _saveSettings() async {
    ...
    await prefs.setBool('availability_status', _availabilityStatus);
    ...
    if (user != null) {
      await FirebaseFirestore.instance
          ...
          .doc(user.uid)
          .update({
        'isAvailable': _availabilityStatus,
      });
    }
  }
        ...
        children: [
          ...
          Card(
            ...
            child: ListTile(
              ...
              subtitle: Text(providerData?['email'] ?? 'provider@example.com'),
              trailing: IconButton(
                icon: Icon(Icons.edit),
                onPressed: () {
                  Navigator.pushNamed(context, '/editprofileprovider');
                },
              ),
            ),
          ),
...
// Change Password Page (can be the same as user's change password page)
