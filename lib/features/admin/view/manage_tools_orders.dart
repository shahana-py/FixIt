...
//     return paymentId != 'N/A' && paymentId.isNotEmpty ? 'Completed' : 'Pending';
//   }
//
...
//               ],
//             ),
//             if (orderData['review'] != null && orderData['review'].toString().isNotEmpty) ...[
//               const SizedBox(height: 16),
//               const Text(
//                 'Review:',
...
//             child: Text("Your Orders",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w600,color:Color(0xff0F3966)),),
//           ),
//
//           // Orders List
//           Expanded(
